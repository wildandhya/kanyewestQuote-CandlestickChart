...
import getQuoteAction from "../redux/action/kanyewestQuote";
import "../styles/kanyewestQuote.css";

function KanyewestQuote() {
  const dispatch = useDispatch();
  const quote = useSelector((state) => state.dataQuote.data);
      ...
      <div className='wrapper'>
        <div className='header'>
          <img
            ...
            style={{ width: 300 }}
          />
          <h1 className='title_header'>Kanye west Quote</h1>
        </div>
